...
Both the functions that update the config file and that process the results data can be defined by the user. Check our [documentation](https://physicool.readthedocs.io) for some examples.
